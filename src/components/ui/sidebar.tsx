...
// Provider component supplying sidebar context
function SidebarProvider({
  ...
  const [openState, _setOpen] = React.useState(defaultOpen)
  ...
  const value = React.useMemo<SidebarContextProps>(
    () => ({
      state: state as SidebarContextProps['state'],
      open,
    ...
    [state, open, openMobile, isMobile, toggleSidebar, setOpen],
  )
  ...
  // (Corrupted implementation removed and replaced by SidebarProvider above)
