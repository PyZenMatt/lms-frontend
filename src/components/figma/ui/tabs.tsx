...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        // active background is the yellow when a tab is selected; the surrounding track uses dark green
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        // When active, background should be #FFD43B and text dark; when inactive, background is transparent and text uses #F7F3EA on the dark track
        ...
        // state styles applied via attributes in runtime; use inline styles below to ensure exact hex colors
        className,
      )}
      {...props}
    />
